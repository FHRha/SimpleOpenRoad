...
| [Gemini CLI OAuth](https://google-gemini.github.io/gemini-cli/docs/get-started/authentication.html) | Experimental Gemini CLI-style OAuth provider for Google AI Pro / Ultra subscriptions. Connect with `sor providers connect google --manual-code`. |
