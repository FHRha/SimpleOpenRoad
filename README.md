...
| [Gemini CLI OAuth](https://google-gemini.github.io/gemini-cli/docs/get-started/authentication.html) | Experimental Gemini CLI-style OAuth provider for Google AI Pro / Ultra subscriptions. Connect with `sor providers connect google`; the wizard starts the official Gemini CLI sign-in when needed. |
