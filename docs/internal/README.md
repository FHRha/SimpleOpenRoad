...
This directory contains historical plans, triage notes, implementation notes, and provider research.

These files are useful for maintainers, but they are not the primary user documentation. Start with the public docs first:
...
| File | Purpose |
|---|---|
| `REQUIREMENTS.md` | Early requirements formalization. Some MVP scope notes are historical. |
